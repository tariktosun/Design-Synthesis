...
class Test_Smores(unittest.TestCase):
    ...
    def setUp(self):
        ...
        b_smores = [ SmoresModule.SmoresModule('0',4, [2,3]), SmoresModule.SmoresModule('1',0, [2,3]) ]
        # build structure:
        ...
        # Superdesign:
        a_smores = [ SmoresModule.SmoresModule( '0', 4 ), SmoresModule.SmoresModule( '1', 2 ) ]
        # build structure:
    ...
    # Broken now that nodes are now rigid bodies.
